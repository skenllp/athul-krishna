...
function PhotoLoader({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    ...
    >
      ...
      <p className="font-serif text-2xl text-[#4F5D2A] mb-2">Athul &amp; Krishna</p>
...
export default function Home() {
  ...
  /* Countdown */
  useEffect(() => {
    const target = new Date("September 13, 2026 11:45:00").getTime();
    const tick = () => {
        ...
        {imagesReady && phase !== "done" && (
          ...
          >
            ...
            <div className="text-center px-6 relative z-10">
              ...
              >Wedding Invitation · Athul &amp; Krishna</motion.p>
              {needsGesture && (
                <motion.div
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: imagesReady && phase === "done" ? 1 : 0 }} transition={{ duration: 1 }}>
        ...
        <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
          ...
          <motion.div className="relative z-10 text-center px-6 py-32" style={{ opacity: heroOpacity }}>
            ...
            >
              <span className="text-white drop-shadow-2xl">Athul</span>
              <span className="text-[#D4AF37] mx-3 md:mx-5 drop-shadow-2xl">&amp;</span>
              <span className="text-white drop-shadow-2xl">Krishna</span>
            </motion.h1>
              ...
              <TiltCard>
                ...
                >
                  ...
                  <p className="text-[#7A7266] text-sm tracking-widest uppercase mt-4">
                    The families of Athul &amp; Krishna joyfully request your gracious presence
                  </p>
                </motion.div>
              </TiltCard>
        ...
        <section id="couple" className="py-24 px-4 bg-gradient-to-b from-[#f6f1e8] to-[#fdfbf7]">
          ...
          <div className="max-w-5xl mx-auto mt-14 grid md:grid-cols-2 gap-10">
            {[
              { src: "/groom.jpg", role: "Groom", name: "Athul Venkitesh", parents: "Son of Mr Anilkumar & Mrs Sreeja" },
              { src: "/bride.jpg", role: "Bride", name: "Krishna S", parents: "Daughter of Mr Shylajan & Mrs Sindhu" },
            ].map((person) => (
        ...
        <section id="photos" className="py-24 px-4 bg-gradient-to-b from-[#f6f1e8] to-[#fdfbf7]">
          ...
          <div className="max-w-6xl mx-auto mt-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            <FadeSection className="sm:col-span-2 lg:col-span-2 h-[340px] md:h-[420px]">
              <GalleryCell src="/gallery1.jpeg" label="Together Forever" />
            </FadeSection>
            <FadeSection className="h-[340px] md:h-[420px]">
              <GalleryCell src="/gallery2.jpeg" label="Hand in Hand" />
            </FadeSection>
            <FadeSection className="h-[300px] md:h-[360px]">
              <GalleryCell src="/gallery3.jpeg" label="Playful Hearts" />
            </FadeSection>
            <FadeSection className="h-[300px] md:h-[360px]">
              <GalleryCell src="/gallery4.jpeg" label="Joyful Smiles" />
            </FadeSection>
            <FadeSection className="h-[300px] md:h-[360px]">
              <GalleryCell src="/gallery5.jpeg" label="Shades of Love" />
            </FadeSection>
            <FadeSection className="h-[300px] md:h-[360px]">
        ...
        <section id="finalbanner" className="relative overflow-hidden">
          <div className="relative h-[60vh]">
            <motion.img src="/gallery2.jpeg" alt="Athul & Krishna"
            ...
            <FadeSection className="absolute inset-0 flex flex-col items-center justify-end pb-16 px-6 text-center">
              ...
              <h2 className="text-5xl md:text-7xl font-serif text-white drop-shadow-2xl">Athul &amp; Krishna</h2>
              <p className="text-white/70 text-lg mt-3 tracking-wider">13 September 2026</p>
            </FadeSection>
          </div>
        </section>
        ...
        <footer className="bg-[#fdfbf7] border-t border-[#D4AF37]/20 py-16 px-4 text-center">
          ...
          <p className="text-[#7A7266] tracking-widest text-sm uppercase mt-4">
            Athul &amp; Krishna · 13 September 2026
          </p>
        </footer>
